    ...
    <div class="container container--with-sidebar">
      <header class="main-header">
        ...
        <div class="main-header__side">
          <a class="main-header__side-item button button--transparent" href="form_authorization.php">Войти</a>
        </div>
      </header>
      ...
      <div class="content">
        <section class="content__side">
          ...
          <a class="button button--transparent content__side-button" href="form_authorization.php">Войти</a>
        </section>
        ...
        <main class="content__main">
          ...
          <form class="form" action="/register.php" method="post" autocomplete="off">
              ...
              <input class="form__input form__input--error" type="text" name="email" id="email" value="<?=$values['email'] ?? ''; ?>" placeholder="Введите e-mail">
            ...
            <div class="form__row">
              ...
              <input class="form__input" type="text" name="name" id="name" value="<?=$values['name'] ?? ''; ?>" placeholder="Введите имя">
            </div>
